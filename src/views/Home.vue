  ...
  <div class="home">
    ...
    <div class="card card-side shadow-xl" v-show="MadePath">
      <div class="card-body">
        ...
        <div>
          <ShareNetwork network="email" title="Shareing Imitation Site" :url="ImitationURL"
          ...
          <label for="my-modal-3" class="btn modal-button btn-wide m-3.5"><svg xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="modal">
            <div class="modal-box relative">
              ...
              <vue-qr :text=ImitationURL :callback="test" qid="ImitationURL" :size="400"></vue-qr>
            </div>
          </div>
        </div>
